...
# We paste the S3 Backend in here because we don't have the code structured as a proper module
# TODO - To fix this
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='none',
        help='Local disk folder for annotation json files'
    )
    parser.add_argument(
        '--data-root',
        type=str,
...
def main():
    ...
    # hack to stop petrel_backend which in openmmlab is set to default process s3
    register_backend('petrel', PetrelBackend, prefixes=['petrel'], force=True)
    
    # This makes our module handle s3 file prefixes
    ...
    if args.db_host != 'none':
        ...
        cfg.mlflow_backend.tracking_uri = args.db_host
    ...
    if args.annotation_local != 'none':
        cfg.train_dataloader.dataset.ann_file = f'{args.annotation_local}/annotations/instances_train2017.json'
        cfg.val_dataloader.dataset.ann_file = f'{args.annotation_local}/annotations/instances_val2017.json'
        cfg.test_dataloader.dataset.ann_file = f'{args.annotation_local}/annotations/instances_val2017.json'
        cfg.val_evaluator.ann_file = f'{args.annotation_local}/annotations/instances_val2017.json'
        cfg.test_evaluator.ann_file = f'{args.annotation_local}/annotations/instances_val2017.json'
